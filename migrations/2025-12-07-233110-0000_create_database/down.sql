...
DROP TRIGGER IF EXISTS wake_on_lan_machines_authorized_users_insert_ts;
DROP TRIGGER IF EXISTS wake_on_lan_machines_authorized_roles_insert_ts;

DROP TABLE IF EXISTS wake_on_lan_machines_authorized_roles;
DROP TABLE IF EXISTS wake_on_lan_machines_authorized_users;

DROP TRIGGER IF EXISTS wake_on_lan_machines_insert_ts;
...
-- Servitor
DROP TRIGGER IF EXISTS servitor_server_authorized_users_insert_ts;
DROP TRIGGER IF EXISTS servitor_server_authorized_roles_insert_ts;

DROP TABLE IF EXISTS servitor_server_authorized_roles;
DROP TABLE IF EXISTS servitor_server_authorized_users;

DROP TRIGGER IF EXISTS servitor_servers_insert_ts;
